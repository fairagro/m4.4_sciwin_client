...
```bash
wget https://raw.githubusercontent.com/fairagro/sciwin/refs/heads/main/testdata/hello_world/data/population.csv
wget https://raw.githubusercontent.com/fairagro/sciwin/refs/heads/main/testdata/hello_world/data/speakers_revised.csv
```
