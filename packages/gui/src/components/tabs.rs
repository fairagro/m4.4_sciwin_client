...
pub fn Tabs(props: TabsProps) -> Element {
    rsx! {
        tabs::Tabs {
            class: props.class +  " grid h-full w-full grid-rows-[auto_1fr]",
...
pub fn TabTrigger(props: TabTriggerProps) -> Element {
    rsx! {
        tabs::TabTrigger {
            class: "py-1 px-3 rounded-t-md bg-zinc-300 hover:bg-zinc-200 data-[state=active]:bg-white data-[state=active]:border-b-0 border border-zinc-400",
            id: props.id,
            value: props.value,
            index: props.index,
...
pub fn TabContent(props: TabContentProps) -> Element {
    rsx! {
        tabs::TabContent {
            class: props.class.unwrap_or_default() + " b-1",
            value: props.value,
            id: props.id,
            index: props.index,
            attributes: props.attributes,
